...
"fix menu mis encoding problem
source $VIMRUNTIME/delmenu.vim
source $VIMRUNTIME/menu.vim
"fix console message mis encoding problem
...
" fix gitgutter's problem of E484(https://github.com/airblade/vim-gitgutter/issues/106)
...
set foldlevel=99    "Start with no folds closed:99; all closed:0
...
nmap <F7> :CoffeeCompile watch<CR>
...
" map F5 to reload the current file
nmap <F5> :e!<CR>
